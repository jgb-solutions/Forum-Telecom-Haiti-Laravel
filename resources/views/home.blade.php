...
@include('menu')
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-8 col-md-offset-2">
                        ...
                        <p class="intro-text">
                            La renconttre des acteurs de télécommunications d'Haiti.
                        </p>
                        <a href="#fiche-technique" class="btn btn-circle page-scroll">
    ...
    <section id="fiche-technique" class="content-section text-center noselect">
        <div class="container">
            <div class="row">
    ...
    <section id="objectif" class="content-section text-center bg-red noselect">
        <div class="container">
            <div class="row">
                <div class="col-lg-8 col-lg-offset-2">
                    <h2>OBJECTIF</h2>

                    <p>GESTE-Haïti poursuivra l&#39;un de ses objectifs à travers FORUM TELECOM HAITI qui est de promouvoir les Nouvelles Technologie de l’information et de la communication (NTIC) pour le développement éducatif et socio économique du pays.</p>

                    <p>Forum Telecom Haïti a pour objectif principal:</p>

                    <p><em>Sensibiliser les acteurs des Télécommunications, le secteur public et privée en général

                    sur l&#39;importance de la journée mondiale des télécommunications et sur le Thème de cette année</em></p>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-8 col-lg-offset-2">
                    ...
                    <p>
                        <a href="mailto:info@forumtelecomhaiti.com">info@forumtelecomhaiti.com</a>
                    </p>
                    <ul class="list-inline banner-social-buttons">
                        <li>
                            <a href="https://facebook.com/forumtelecomhaiti" target="blank" class="btn btn-default btn-lg"><i class="fa fa-facebook fa-fw"></i> <span class="network-name">Facebook</span></a>
                        </li>
                         <li>
                            <a href="https://twitter.com/forumtelecomht" target="blank" class="btn btn-default btn-lg"><i class="fa fa-twitter fa-fw"></i> <span class="network-name">Twitter</span></a>
                        </li>
                    </ul>
                </div>
            </div>
