...
@include('menu')
    ...
    <!-- a-propos Section -->
    <section id="a-propos" class="content-section text-center noselect">
        <div class="container">
            <div class="row">
    ...
    <section id="evenement" class="content-section text-center noselect bg-blue">
        <div class="container">
            <div class="row">
                <div class="col-lg-8 col-lg-offset-2">
                    <h2>L'Événement</h2>

                    <p>La première édition de Forum Telecom Haïti, se déroulera pendant deux (2) jours, du 17 au 18 Mai 2016 de 9h00 am à 5h00 pm à l’Hotel Royal Oasis sous le Thème Mondiale de L’Union Internationale De Telecommunications (UIT)</p>
    ...
    <!-- Contact Section -->
    <section id="contact" class="content-section text-center bg-blue">
        <div class="container">
            <div class="row">
                <div class="col-lg-8 col-lg-offset-2">
                    ...
                    <ul class="list-inline banner-social-buttons">
                        <li>
                            <a href="https://facebook.com/forumtelecomhaiti" target="blank" class="btn btn-default btn-lg light"><i class="fa fa-facebook fa-fw"></i> <span class="network-name">Facebook</span></a>
                        </li>
                         <li>
                            <a href="https://twitter.com/forumtelecomht" target="blank" class="btn btn-default btn-lg light"><i class="fa fa-twitter fa-fw"></i> <span class="network-name">Twitter</span></a>
                        </li>
                    </ul>
                </div>
            </div>
